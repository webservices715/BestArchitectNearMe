...
const ArchitectCard = ({
  ...
  return (
<Link
  to={`/architectdetail/${id}?image=${encodeURIComponent(image)}&name=${encodeURIComponent(name)}&title=${encodeURIComponent(title)}&description=${encodeURIComponent(description)}&rating=${rating}&address=${encodeURIComponent(address)}&phone=${encodeURIComponent(phone)}&social=${encodeURIComponent(JSON.stringify(social))}`}
>
