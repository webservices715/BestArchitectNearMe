...
function BlogSection() {
  return (
    <section class="py-24 ">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 font-barlow">
      <h2 class="text-4xl font-bold text-gray-900 text-center mb-2">Our latest  blog</h2>
      ...
      <div class="flex justify-center  gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8">
         <div class="group w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl">
          ...
          <div class="p-4 lg:p-6 transition-all duration-300 rounded-b-2xl group-hover:bg-gray-50">
              <span class="text-red-600 font-medium mb-3 block">Jan 01, 2023</span>
              ...
              <a href="javascript:;" class="cursor-pointer text-lg text-red-600 font-semibold">Read more..</a>
          </div>
         </div>
         <div class="group w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl">
          <div class="flex items-center">
          ...
          <div class="p-4 lg:p-6 transition-all duration-300 rounded-b-2xl group-hover:bg-gray-50">
              <span class="text-red-600 font-medium mb-3 block">Feb 01, 2023</span>
         ...
         <div class="group w-full max-lg:max-w-xl lg:w-1/3 border border-gray-300 rounded-2xl">
          ...
          <div class="p-4 lg:p-6 transition-all duration-300 rounded-b-2xl group-hover:bg-gray-50">
              <span class="text-red-600 font-medium mb-3 block">Mar 01, 20233</span>
    ...
    <a href="javascript:;" class="cursor-pointer border border-red-400 shadow-sm rounded-full py-3.5 px-7 mt-12 w-52 flex justify-center items-center text-gray-900 font-semibold mx-auto transition-all duration-500 ease-in-out hover:text-white hover:bg-red-500">View All</a>
</section>
