  ...
  return (
    <section className="flex items-center justify-center bg-[#1F212B] md:h-[70vh] py-10 md:py-0 ">
      <div className="main w-[90%] md:w-[80%] text-[#FFFFFF] flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="middle-section font-sans flex flex-col items-center justify-center w-full md:w-[30%]  mb-6 md:mb-0 text-center md:text-left">
          <p className="uppercase text-[#FD4732] text-lg mt-8 md:text-base py-3 font-bold tracking-[.2rem]">Our Professionals</p>
          <p className="text-[#b5b6c5] text-lg md:text-2xl font-bold leading-snug">A Construction Company Based In London Group Working Since 1995</p>
          <p className="flex flex-col items-center md:items-center mt-8">
            <span className="font-bold text-[4rem] md:text-[5rem]">150+</span>
